...
<header class="contain-to-grid<?php if ( is_page_template( 'home.php') )  { ?> home<?php	} ?>">
	...
	<nav class="top-bar" data-topbar>
	    <ul class="title-area">
	        <li class="name">
	        	<h1><a href="https://amylymanauthor.com" title="Amy Wilinski-Lyaman" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
	        </li>
...
<div class="container<?php if(is_front_page()){ echo " blogHome"; } ?>" role="document">
